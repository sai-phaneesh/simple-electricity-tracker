...
final class CreateCycleEvent extends DashboardEvent {
  ...
  @override
  List<Object> get props => [startDate, endDate, name, meterReading, maxUnits];
}
...
class CreateConsumptionEvent extends DashboardEvent {
  ...
  CreateConsumptionEvent({required this.cycleId, required this.meterReading});
...
class DeleteCycleEvent extends DashboardEvent {
  ...
  DeleteCycleEvent({required this.cycleId});
...
class DeleteConsumptionEvent extends DashboardEvent {
  ...
  DeleteConsumptionEvent({required this.cycleId, required this.consumptionId});
